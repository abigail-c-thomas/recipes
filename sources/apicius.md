...
The following recipes from our collection come from Apicius:

{% assign apicius_recipes = site.pages | where: "layout", "recipe" | where: "source", "apicius" %}
<ul>
  {% for recipe in apicius_recipes %}
